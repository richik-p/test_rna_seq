...
#A=$OUTPUT_DIR/trimmed_files/hcc1395_normal_rep1_r1_paired.fq.gz
#B=$OUTPUT_DIR/trimmed_files/hcc1395_normal_rep1_r2_paired.fq.gz
...
rsem-calculate-expression --bam --no-bam-output -p 10 --paired-end --forward-prob 0 $OUTPUT_DIR/STAR_alignment/hcc1395_normal_rep1Aligned.toTranscriptome.out.bam $RSEM_DIR $OUTPUT_DIR/RSEM_counts/hcc1395_normal_rep1 >& $OUTPUT_DIR/RSEM_counts/hcc1395_normal_rep1.log # change the file name to match the sample